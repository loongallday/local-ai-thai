...
const integrations = [
  ...
  { name: "SAP", iconSlug: "sap", iconFallback: "📊", color: "#0FAAFF", desc: "ดึงข้อมูลจาก ERP" },
  { name: "Odoo", iconSlug: "odoo", iconFallback: "🟣", color: "#714B67", desc: "CRM, POS, Inventory" },
  { name: "REST API", emoji: "🔌", color: "#00e5ff", desc: "เชื่อมกับ app ใดก็ได้" },
  { name: "Webhook", iconSlug: "webhook", iconFallback: "🪝", color: "#f59e0b", desc: "Trigger อัตโนมัติ" },
];
